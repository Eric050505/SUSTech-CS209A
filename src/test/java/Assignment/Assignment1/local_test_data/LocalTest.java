package Assignment.Assignment1.local_test_data;

import Assignment.Assignment1.OlympicsAnalyzer;
...
public class LocalTest {
    ...
    OlympicsAnalyzer olympicsAnalyzer = new OlympicsAnalyzer(Paths.get("src/test/java/Assignment/Assignment1", "local_test_data").toString());
...
//    }
    ...
    void bmiBySports() {
        ...
        expectedSports.put("Weightlifting", 27.4f);//27.4
        expectedSports.put("Bobsleigh", 26.7f);//26.7
